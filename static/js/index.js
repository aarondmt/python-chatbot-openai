...
async function enviarMensagem() {
  ...
  let respostaParcial = "";
  while (true) {
    // Aguarda e recebe o próximo pedaço de resposta da API
    const { done: terminou, value: pedacoDaResposta } =
      await leitorDaResposta.read();
    if (terminou) break;

    // Concatena o novo pedaço da resposta com a reposta parcial e atualiza na tela
...
function limparConversa() {
  ...
  chat.innerHTML =
    "<p class='chat__bolha chat__bolha--bot'>Olá! Eu sou o assistente virtual da EcoMart ~<br/><br/>Como posso te ajudar?</p>";
}
